...
do   
	...
	qsub -v NAME=$name,DATADIR=$datadir,DT=0.002,NSTEPS=2000000,FRAMERATE=20000,XBOX=195,YBOX=195,XDIM=15,YDIM=90,ZDIM=3,XLINK=$xlink,DRIVE=$drive,KBT=0.2,KX=10.0,LX=1.122 ~/mvarga/worms/exp/xlinkers.pbs
    done
done
